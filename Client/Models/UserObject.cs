...
namespace Client.Models
{
    public sealed class UserObject : PlayerObject
    {
        ...
        public ObjectAction MagicAction { get; set; }
        ...
        public bool CanThrusting
        {
            ...
            set
            {
                ...
                GameScene.Game.ReceiveChat(CanThrusting ? "使用 刺杀剑术." : "不使用 刺杀剑术.", MessageType.Hint);
            }
        }
        ...
        public bool CanHalfMoon
        {
            ...
            set
            {
                ...
                GameScene.Game.ReceiveChat(CanHalfMoon ? "使用 半月弯刀." : "不使用 半月弯刀.", MessageType.Hint);
            }
        }
        ...
        public bool CanDestructiveBlow
        {
            ...
            set
            {
                ...
                GameScene.Game.ReceiveChat(CanDestructiveBlow ? "使用 十方斩." : "不使用 十方斩.", MessageType.Hint);
            }
        }
        ...
        public bool CanFlameSplash
        {
            ...
            set
            {
                ...
                GameScene.Game.ReceiveChat(CanFlameSplash ? "使用 新月爆炎龙." : "不使用 新月爆炎龙.", MessageType.Hint);
            }
        }
            ...
            switch (action.Action)
            {
                ...
                case MirAction.Attack:
                    ...
                    if (CanHalfMoon && (TargetObject != null || (GameScene.Game.MapControl.CanHalfMoon(action.Direction) &&
                                             GameScene.Game.MapControl.HasTarget(Functions.Move(CurrentLocation, action.Direction)))))
                    {
                        foreach (KeyValuePair<MagicInfo, ClientUserMagic> pair in Magics)
                        {
