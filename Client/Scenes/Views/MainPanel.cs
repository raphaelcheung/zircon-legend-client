...
namespace Client.Scenes.Views
{
    public sealed class MainPanel : DXImageControl
    {
        ...
        public DXLabel ClassLabel { get; set; }
        public DXLabel LevelLabel, ACLabel, MRLabel, DCLabel, MCLabel, SCLabel, AccuracyLabel, AgilityLabel, HealthLabel, ManaLabel, ExperienceLabel, AttackModeLabel, PetModeLabel;
        ...
        public MainPanel()
        {
            ...
            label.Location = new Point(300 - label.Size.Width, 21);
