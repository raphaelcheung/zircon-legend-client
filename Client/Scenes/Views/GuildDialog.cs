...
namespace Client.Scenes.Views
{
    public sealed class GuildDialog : DXWindow
    {
        ...
        public void CreateCreateTab()
        {
            ...
            label = new DXLabel
            {
                ...
                IsControl = false,
                Hint = "基础容量: 10" +
                       $"每增加一人所需费用: {Globals.GuildMemberCost}."
            };
            ...
            label = new DXLabel
            {
                ...
                IsControl = false,
                Hint = "基础容量: 10," +
                       $"每增加一个仓位所需费用: {Globals.GuildStorageCost}."
            };
        ...
        public void CreateManageTab()
        {
            ...
            {
                Parent = GuildWarPanel,
                Text = $"消费: {Globals.GuildWarCost:#,##0} 金币",
                Location = new Point(ClientArea.X + 55, label.Location.Y + 25),
            };
    ...
    public sealed class GuildMemberDialog : DXWindow
    {
        ...
        public GuildMemberDialog()
        {
            ...
            {
                DXMessageBox box = new DXMessageBox($"你确认要将 {MemberNameLabel.Text} 从帮会开除吗", "开除", DXMessageBoxButtons.YesNo);
